// Dados das pizzas, p/ simular um  json
let pizzaJson = [
    ...
    {id:4, name:'Americana', img:'images/pizza4.png', price:20.00, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
